...
class CalendarStrip extends Component {
  ...
  _renderHeader = () => {
    ...
    const {filtersActive, isClassFilterVisible} = this.props;
    ...
    return (
        <View style={styles.header} pointerEvents={isClassFilterVisible ? 'auto' : 'none'}>
          <TouchableOpacity
              style={styles.button}
              onPress={this.props.onFilterPress}>
            {isClassFilterVisible &&
...
CalendarStrip.propTypes = {
  ...
  isClassFilterVisible: PropTypes.bool
};
