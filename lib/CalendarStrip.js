...
class CalendarStrip extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return !isSameDay(nextProps.selectedDate, this.props.selectedDate)
        ...
        || !isEqual(nextProps.isFiltersVisible, this.props.isFiltersVisible)
  ...
  _renderHeader = () => {
    ...
    const {filtersActive, isFiltersVisible} = this.props;
    ...
    return (
        <View style={styles.header}>
          <View style={styles.button} pointerEvents={isFiltersVisible ? 'auto' : 'none'}>
            <TouchableOpacity
