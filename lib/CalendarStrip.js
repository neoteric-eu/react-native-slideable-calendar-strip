...
class CalendarStrip extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      lastItemDate: this.props.selectedDate
    };
  }
  ...
  render() {
    ...
    const isCurrentWeek = isSameWeek(selectedDate, this.state.lastItemDate, {weekStartsOn: 0})
    ...
    return (
        <Animated.View
          ...
          {this._renderBG()}
          {this._renderHeader()}
          <Weeks selectedDate={selectedDate} isCurrentWeek={isCurrentWeek}/>
          <FlatList
